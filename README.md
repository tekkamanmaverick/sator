...
5. Start sator with `./sator.sh`. In this case the parameter file name defaults to *par.txt*. If you are starting sator for the first time, the library files should first be complied.
